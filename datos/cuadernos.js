...
window.CUADERNOS = [
...

  {
    ...
    color:"#26468c",
    prof:"Kogan y Wang",
    modulos:10, ejemplos:24, retos:10, min:135,
    orden:2,
    pre:"Cálculo y álgebra lineal",
    res:"La base de todo el programa: el valor de un activo es el valor de mercado de sus flujos. Versión desarrollada, con 31 derivaciones paso a paso de dónde sale cada fórmula.",
